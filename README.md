...
또한 Upstash를 설정해두면, **통합 해석 보고서 생성 시마다 자동으로 서버에도 저장**되어
루트 화면의 "저장된 보고서 목록 보기"에서 재입력 없이 다시 열어볼 수 있습니다.
이 저장본은 **30일 후 자동 삭제**됩니다 (`REPORT_RECORD_TTL_SECONDS`에서 조정 가능).
